...
- [Support](https://crdroid.net/donate)
...
crDroid is open source and community driven.
...
Be careful when flashing custom ROMs.
Some ROMs, including DerpFest, are closed source and maintained by developers
who are banned from major Android communities.

Closed source ROMs cannot be audited. You cannot verify what code runs on your
device. This increases the risk of malware, data leaks, and unauthorized access
